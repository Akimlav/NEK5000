...
def stuck (case_name, file_ext):
    ...
    hot_wall = [data[i,:] for i in range (0, num_rows) if data[i,2] == -0.5]
    cold_wall = [data[i,:] for i in range (0, num_rows) if data[i,2] == 0.5]
    cold_ceiling = [data[i,:] for i in range (0, num_rows) if data[i,3] == 0.5]
    hot_floor = [data[i,:] for i in range (0, num_rows) if data[i,3] == -0.5]
    adiabatic_front = [data[i,:] for i in range (0, num_rows) if data[i,4] == 0.5]
    adiabatic_back = [data[i,:] for i in range (0, num_rows) if data[i,4] == -0.5]
    ...
    plt.figure(1)
    plt.title('cold wall')
    plt.plot(cold_wall[:,3],cold_wall[:,4],'bo',markersize=1)
    #plt.legend()
    plt.xlabel('Z')
    plt.ylabel('Y')
    plt.ylim(-0.5,0.5)
    ...
    plt.plot(cold_ceiling[:,2],cold_ceiling[:,4],'bo',markersize=1)
    #plt.legend()
    plt.xlabel('X')
    plt.ylabel('Z')
    plt.ylim(-0.5,0.5)
    ...
    plt.figure(1)
    plt.title('hot floor')
    plt.plot(hot_floor[:,2],hot_floor[:,4],'ro',markersize=1)
    #plt.legend()
    plt.xlabel('X')
    plt.ylabel('Z')
    plt.ylim(-0.5,0.5)
    ...
    plt.plot(adiabatic_front[:,2],adiabatic_front[:,3],'o',markersize=1)
    #plt.legend()
    plt.xlabel('X')
    plt.ylabel('Y')
    plt.ylim(-0.5,0.5)
    ...
    plt.plot(adiabatic_back[:,2],adiabatic_back[:,4],'o',markersize=1)
    #plt.legend()
    plt.xlabel('X')
    plt.ylabel('Y')
    plt.ylim(-0.5,0.5)
...
def menu():
    ...
    strs = (
            ...
            '4. Plot all \n'
            '5. Contoniue plot all \n'
            '6. Plot stuck particles \n'
            '9. Create video\n'
            '0. Exit\n'
            '--- Your choice : ')
...
while True:
    ...
    if choice == 1: # PDF
        ...
        args2 = list(['s',0 ,'2D',0, np.asarray([0.25,0.25,0]), 0.15, 'o'])
